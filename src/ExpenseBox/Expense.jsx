...
import ExpenseSvg from "../Components/ExpenseSvg";
...
export default function Expense({
  ...
  HandleDropDown("menu-button2", "menud-dropdown", setisOpenSort);
  HandleDropDown("filter-button-2", "filter-dropdown2", setisOpenFilter);

  const result = expenseList ? expenseList : expenseArray;
